...
#     cerise_job_id = srv_data['cerise_job_id']

#     try:
#         srv = cc.service_from_dict(srv_data)
#         cc.start_managed_service(srv)
#         srv.get_job_by_id(cerise_job_id)
#         print("Job {} already running".format(cerise_job_id))

#     except cc.errors.ServiceNotFound:
#         print("There is no cerise service running")
#         srv_data = yield start_from_scratch(cerise_job_id, gromacs_config, cerise_config, cerise_db)

#     except cc.errors.JobNotFound:
#         print("There is no job named: {} in the cerise service: {}".format(
#             cerise_job_id, srv_data['name']))
#         srv_data = yield start_from_scratch(cerise_job_id, gromacs_config, cerise_config, cerise_db)
...
# @chainable
# def start_from_scratch(cerise_job_id, gromacs_config, cerise_config, cerise_db):
#     """
